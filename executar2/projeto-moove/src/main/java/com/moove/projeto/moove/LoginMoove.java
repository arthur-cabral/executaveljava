...
void ConexaoBanco() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 100, 30));

        LBabrircad.setBackground(new java.awt.Color(0, 102, 255));
        LBabrircad.setFont(new java.awt.Font("Berlin Sans FB", 0, 24)); // NOI18N
        ...
        jPanel1.add(LBabrircad, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 290, 30));
